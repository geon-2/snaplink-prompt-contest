...
class UsageLedger(Base):
    ...
    chat_input_tokens_le_200k: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    chat_input_tokens_gt_200k: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    chat_output_tokens_le_200k: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    chat_output_tokens_gt_200k: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    image_input_tokens: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    image_text_output_tokens: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    image_output_tokens: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
